...
const WorkSection = () => {
    return <div className="max-w-6xl mx-auto py-20 px-10 w-full space-y-12">
        <h1 className="text-center text-4xl font-light">Projects</h1>
        <div className="flex flex-col gap-y-12">
            {projectsList.map(project => {
                return <div
                    className="flex flex-col gap-6 p-4  rounded-2xl lg:flex-row justify-between items-center border border-transparent hover:border-neutral-700 duration-200 transition-all"
                    key={project.id}>
                    ...
                    <div className="">
                        <Link href={project.url} target={"_blank"}>
                            <Image
                                className=" duration-200 transition-all min-w-[330px] lg:w-[330px] grayscale hover:grayscale-0 border-none rounded-xl"
